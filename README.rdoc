...
==Example
  ...
  => #<Marjan::IpInfoDb::Location status="OK", city="Ternopil", longitude="25.5833", ip="217.196.166.138", latitude="49.55", country_code="UA", region_name="Ternopil's'ka Oblast'",   zip_postal_code="", id="0", country_name="Ukraine", region_code="22">
